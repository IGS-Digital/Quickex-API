...
| ------------ |
|Этот запрос получает ограничение на количество базовой валюты, которое может быть обменено в Quickex в данный момент. Любая избыточная сумма будет отправлена на адрес возврата. Это значение может меняться из-за внезапных колебаний рынка.|
